...
public class Player : MonoBehaviour
{
    ...
    private void LateUpdate() 
    {
        ...
        var flashlightTarget = playerCharacter.GetFlashlightTarget();
        var state = playerCharacter.GetState();

        cameraFollow.UpdatePosition(cameraTarget);
        playerCamera.UpdatePosition(flashlightTarget);   

        cameraFollow.UpdateRotation(flashlight);    
